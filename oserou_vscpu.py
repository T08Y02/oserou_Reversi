...
def score_learning(ban, color):
    ...
    score = score_initialize(10, 7, 6, 4, 1)
    ...
    for gyou in range(8):
        for retsu in range(8):
            ...
            if score_count(ban, gyou, retsu, 2) > 0:
                score[gyou][retsu] = score[gyou][retsu] + score_count(ban, gyou, retsu, 2) 
                    ...
                    for m in range(len(linei2)):
                        ...
                        if linei2[m] == thisincdec2d[kaiseki]:
                            if len(linei2[m]) == 0:
                                ...
                                a = math.ceil(math.log(int(linei[m][0]), 100))
                                if score[gyou][retsu] > 0:
                                    score[gyou][retsu] *= a
                                elif score[gyou][retsu] == 0:
                                    score[gyou][retsu] += 1
                                    score[gyou][retsu] *= a
                                #print(a)
                            break
...
for kaisuu in range(1):
    ...
    suuji = 1
    filename = "oserou_log_new/oserou_log_incdec{}.csv".format(str(suuji))
